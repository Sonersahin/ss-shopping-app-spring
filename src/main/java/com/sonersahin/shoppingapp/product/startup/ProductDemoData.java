package com.sonersahin.shoppingapp.product.startup;

import com.sonersahin.shoppingapp.filestore.service.FileStoreService;
...
import com.sonersahin.shoppingapp.product.model.product.ProductResponse;
import com.sonersahin.shoppingapp.product.model.product.ProductSaveRequest;
import com.sonersahin.shoppingapp.product.repository.es.ProductEsRepository;
import com.sonersahin.shoppingapp.product.service.ProductService;
import com.sonersahin.shoppingapp.product.service.category.CategorySaveRequest;
        ...
        if (countOfData.equals(0L)){
            ...
            IntStream.range(0, 20).forEach(item -> {
                HashMap<MoneyTypes, BigDecimal> price = new HashMap<>() {{
                    put(MoneyTypes.USD, BigDecimal.valueOf((item + 1) * 5L));
                    put(MoneyTypes.EUR, BigDecimal.valueOf((item + 1) * 4L));
                }};
